...
gitHubAPI.controller('gitHubAPIController', function ($scope, $http, $sce) {
    ...
    $scope.search = function () {
        ...
        $scope.followers.forEach(function (follower) {
            if ($scope.searchKeywords != '' && follower.login.toLowerCase().includes($scope.searchKeywords)) {
        ...
        $scope.following.forEach(function (following) {
            if ($scope.searchKeywords != '' && following.login.toLowerCase().includes($scope.searchKeywords)) {
